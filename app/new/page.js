  ...
  return (
    <div className="max-w-lg">
      ...
      <p className="text-sm text-steel mb-8">
        Isi data karyawan, sistem akan membuatkan 4 link clearance secara otomatis.
      </p>
      ...
      >
        <div>
          <label className="block text-sm font-medium text-ink mb-1.5">Nama Karyawan</label>
          <input
            name="nama_karyawan"
            required
        ...
        <div>
          <label className="block text-sm font-medium text-ink mb-1.5">Posisi</label>
          <input
            name="posisi"
            required
            className="w-full border border-line rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-ink"
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium text-ink mb-1.5">Efektif Terakhir</label>
            <input
              type="date"
